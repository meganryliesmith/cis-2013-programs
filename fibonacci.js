...
var generate = function () 
{
    ...
    {
        while(intCount>2) //loop to develop the Fibonacci sequence; runs until the desired value of numbers has been reached
        {
            k=i+j;
            i=j;
            j=k;
        ...
        $("output").value = stringOutput; //outputs Fibonacci sequence to the DOM
    }
